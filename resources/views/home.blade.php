            ...
            <div class="row mt-5">
                ...
                <div class="col-md-6">
                    <div id="about-content" class="p-5 text-light text-center" style="background-color: #2B6EB5;">
                        Badan Eksekutif Mahasiswa Universitas Kristen Maranatha (BEM UKM) merupakan organisasi mahasiswa UKM
                        yang memegang fungsi eksekutif skala Universitas. BEM UKM lahir untuk memberikan jawaban dari
                        berbagai macam persoalan serta mempersatukan mahasiswa UKM menjadi #kitasatumaranatha
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="logo" class="p-5">
            ...
            <div id="logo-content" class="mt-5">
                <ul>
                    ...
                    <li>Pada logo dapat terlihat stilasi dari orang-orang yang sedang berkumpul melambangkan sebuah <span
                            style="font-weight: 800;">community.</span></li>
                    <li>Tampilan logo yang tampak tersambung satu sama lain tanpa terputus mencerminkan <span
                            style="font-weight: 800;">connection</span> dan bond/ikatan yang terjalin dalam BEM Marantha
                        baik dengan
                        sesama anggota maupun pihak luar.</li>
                    <li>3 bulatan pada bagian atas logo merepresentasikan 3 nilai Universitas Kristen Maranatha yaitu <span
                            style="font-weight: 800;">Integrity, Care, dan Excellence.</span></li>
